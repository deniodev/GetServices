...
import {
  BsTwitterX, BsYoutube, BsGithub, BsFacebook,
} from 'react-icons/bs';
  ...
  return (
    <div className="pb-4  border">
      <div className="text-center mt-4 text-sm pb-2 ">
        ...
        {' '}
        <Link to="https://github.com/deniodev/home-services" target="_blank"><span className=" hover:underline font-semibold">GitHub</span></Link>
      </div>
